...
{   
    ...
    public  void initialize(){
       ...
       roomsList.add(new Room(Floor.GROUND,1,Name.ICU,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.DAY,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.OPERATING_THEATRE,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.SICK,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.DELIVERY,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.CONSULTING,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.EMERGENCY,RoomType.SINGLE_AC));
       roomsList.add(new Room(Floor.GROUND,1,Name.CONSULTING,RoomType.SINGLE_AC));
        }
    ...
    public  void checkIn(String id){
        ArrayList<Attendance> list=getAttendanceReport().get(LocalDate.now());
        if(list==null){
